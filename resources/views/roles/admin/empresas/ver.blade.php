                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input required name="nombre" type="text" value="{{ $empresa->nit }}" disabled class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label  class="mb-0" for="nit">Dirección:</label>
                            <input required name="direccion" type="text" value="{{ $empresa->direccion }}"  disabled class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="mb-0" for="nit">Email:</label>
                            <input required name="email" type="email" value="{{ $empresa->email }}" disabled class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="mb-0" for="nit">Teléfono:</label>
                            <input required name="telefono" type="text" value="{{ $empresa->telefono }}" disabled class="form-control form-control-sm">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="mb-0" for="nit">Estado:</label>
                            <select disabled name="estado" id="estado" class="form-control form-control-sm">
