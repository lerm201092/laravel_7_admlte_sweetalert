        ...
        <div class="card-body px-4">
            ...
            <div class="row">
                ...
                <div class="col-12 mt-5 <?=($sw)?>" id="divCli1">
                    <p style="border-bottom: 2px solid #6c757d; font-weight: 600; color:#6c757d;">Clinica asociada</p> 
                </div>

                <div class="col-md-12 <?=($sw)?>" id="divCli2">
                    <div class="form-group">
                        <label class="mb-0" for="dpto">Clinica:</label>
                        <select disabled name='id_empresa' class="form-control form-control-sm">
            ...
            <div class="row mt-4">
                <div class="col-12">
                    <a href="{{ route('AdminUsuariosListado') }}" class="btn bg-secondary text-light btn-sm"><i
